...
| - | ------------------------------------------------------------------------ | ------------------------------------------------ | -------------------------------------------------------------------------------- | ------------------------- |
| 1 | `icc26/site1/upstream/br-201/sample-valve-01/event/vlv-badge-scanned`    | sim-valve-mqtt                                   | Every badge, granted or denied                                                   | vlv-badge-scanned         |
| 1 | `icc26/site1/upstream/br-201/sample-valve-01/event/sample-acq-completed` | sim-valve-mqtt                                   | A sample that actually ran                                                       | sample-acq-completed      |
...
| 3 | `icc26/site1/qc/analyzers/cell-analyzer-01/sample-analyzed`              | Ignition, event stream `cell-analyzer-result`    | Analyzer result on sample complete                                               | sample-analyzed           |
| 4 | `icc26/site1/qc/lims/sample-results-released`                            | Ignition, `lims_webhook`                         | Reviewed record: analyst and pass/fail                                           | sample-results-released   |
...
| 6 | `icc26/site1/env_monitoring/particle-counter-01/sample-analyzed`         | Ignition, event stream `particle-counter-result` | One particle-count analysis                                                      | sample-analyzed           |
| 7 | `icc26/site1/qc/deviation`                                               | Ignition, event stream `lims-review`             | The aggregate, and only when something was violated                              |                           |
| 7 | `icc26/site1/qc/i3x-meta-review-completed`                               | i3x-client                                       | The external reader's verdict. Off until Start publishing is pressed             | i3x-meta-review-completed |
