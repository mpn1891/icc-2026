...
> **Extra — not the talk.** Pattern 4 was a LIMS until 2026-08-23. This is the as-built talk
> track, restored from git. Live pattern 4:
> [`../04-novaflex-webhook.md`](../04-novaflex-webhook.md). Spec:
> [`lims-webhook-spec.md`](lims-webhook-spec.md). Index: [`README.md`](README.md).
>
> Architecture decisions live in [`../00-architecture.md`](../00-architecture.md).
