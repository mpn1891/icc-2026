...
06 is built — see above, and **07 is not the next thing to do.**
[`00-pre-07-cleanup.md`](00-pre-07-cleanup.md) is the current step: the defects 07 would inherit,
and the decisions its spec cannot be written without. Branch `pattern7_and_cleanup`.
